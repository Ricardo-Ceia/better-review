...
The web mode binds to `127.0.0.1`, opens a browser with a local session token, and supports refresh, file/hunk accept or reject actions, unreview, and committing accepted changes.
